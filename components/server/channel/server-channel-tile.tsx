                ...
                channel.name !== "general" && role !== MemberRole.USER && (
                    <div className="ml-auto flex items-center gap-x-2">
                        <ActionTooltip label="Edit Channel" side="top" align="center">
                            <Edit className="hidden group-hover:block w-4 h-4 text-neutral-700/50 hover:text-neutral-800 dark:text-neutral-400/80 hover:dark:text-neutral-300 transition duration-150 ease-in-out"/>
                        </ActionTooltip>
                        <ActionTooltip label="Delete Channel" side="top" align="center">
                            <Trash className="hidden group-hover:block w-4 h-4 text-neutral-700/50 hover:text-neutral-800 dark:text-neutral-400/80 hover:dark:text-neutral-300 transition duration-150 ease-in-out"/>
                        </ActionTooltip>
                    </div>
                )
            }
