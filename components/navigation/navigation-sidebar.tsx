...
import ModeToggle from "@/components/theme-toggle/moddle-toggle-provider";
...
const NavigationSidebar = async () => {
    ...
    return (
        <div className="bg-neutral-400/85 dark:bg-stone-800 w-full py-3 flex flex-col space-y-3">
            <NavigationAction />
